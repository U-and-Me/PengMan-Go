...
<head>
    ...
    <title>PengMan🐧</title>
    <link rel="stylesheet" href="css/Concept_game.css?testNm=10">
	...
	// 1~10 : 1개 / 11 ~ 20 : 2개 / 21 ~ 30 : 3개
		...
		String sql = "select c_word from word where diff='1' and concept='idol' order by rand() limit 1";
		...
		sql = "select c_word from word where diff='2' and concept='idol' order by rand() limit 2";
		pstmt = conn.prepareStatement(sql);
		rs = pstmt.executeQuery();
		while(rs.next()){
		...
		sql = "select c_word from word where diff='3' and concept='idol' order by rand() limit 3";
		pstmt = conn.prepareStatement(sql);
		rs = pstmt.executeQuery();
		while(rs.next()){
    ...
    <div class="warp">
        ...
        <div class="keyboard">
            ...
            <script>                	
            	...
            	let cur_stage = parseInt(window.localStorage.getItem("idol_stage"));
