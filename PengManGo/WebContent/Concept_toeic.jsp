...
<head>
    ...
    <script src="js/Concept_toeic.js?testNm=10" defer></script>
</head>
	...
	// 1~10 : 1개 / 11 ~ 20 : 2개 / 21 ~ 30 : 3개
		...
		String sql = "select c_word from word where diff='1' and concept='toeic' order by rand() limit 1";
		...
		sql = "select c_word from word where diff='2' and concept='toeic' order by rand() limit 2";
		pstmt = conn.prepareStatement(sql);
		rs = pstmt.executeQuery();
		while(rs.next()){
		...
		sql = "select c_word from word where diff='3' and concept='toeic' order by rand() limit 3";
		pstmt = conn.prepareStatement(sql);
		rs = pstmt.executeQuery();
		while(rs.next()){
...
<body>
    <div id="back">
            ...
            <a href="./Level_toeic.jsp"><img id="char" src="img/character.png"></button></a>
            <span id="span">토익</span>
        <div id="back_2">
            <img id="draw_image" src="img\TOEIC_background.png">
            <div id="back_img"></div>
        </div> 
    ...
    <div class="warp">
        ...
        <div class="keyboard">
            ...
            <script>                	
    			...
    			let cur_stage = parseInt(window.localStorage.getItem("toeic_stage"));
    			let word = 0;
                ...
                let audio = new Audio('music/storybgmtoeic.mp3');
