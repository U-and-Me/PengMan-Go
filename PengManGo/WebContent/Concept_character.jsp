...
<head>
    ...
    <script src="js/Concept_character.js?testNm=10" defer></script>
</head>
	...
	// 1~10 : 1개 / 11 ~ 20 : 2개 / 21 ~ 30 : 3개
		...
		String sql = "select c_word from word where diff='1' and concept='character' order by rand() limit 1";
    ...
    <div class="warp">
        ...
        <div class="keyboard">
            ...
            <script>                	
                ...
                let audio = new Audio('music/storybgmcharacter.mp3');
